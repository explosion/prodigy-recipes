...
The original exporter.py has a long standing bug, when SavedModel is exported,
the variables directory is empty. Thus we won't get the required SavedModel
for using with tensorflow serving. Thus use this script instead of the original
"""
import os
import tempfile
