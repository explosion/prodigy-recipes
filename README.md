...
| [`textcat.correct`](textcat/textcat_correct.py)           | Correct the textcat model's predictions manually. Predictions can automatically be preselcted by setting an acceptance threshold (0.5 by default). Prodigy will infer whether the categories should be mutualy exclusive based on the component configuration. |
